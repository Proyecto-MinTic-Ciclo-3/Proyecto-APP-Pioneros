    ...
    return (
      <>
        ...
        <div className="flex flex-row items-center h-screen bg-blue-400 justify-center">
            ...
            <section className='m-10 bg-red-400 p-32 rounded-full text-white'>Productos</section>
            <section className='m-10 bg-red-400 p-32 rounded-full text-white'>Usuarios</section>
        </div>
     </>
    )
}
