...
const FilaVenta = ({ venta }) => {
  ...
  return (
    <tr >
      {edit ? (
        <>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,id_venta:e.target.value})}  value={infoNuevaVenta.id_venta}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,fecha:e.target.value})} value={infoNuevaVenta.fecha}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,producto:e.target.value})} value={infoNuevaVenta.producto}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,id_cliente:e.target.value})} value={infoNuevaVenta.id_cliente}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,vendedor:e.target.value})} value={infoNuevaVenta.vendedor}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,cantidad:e.target.value})} value={infoNuevaVenta.cantidad}></input></td>
          <td><input className="bg-gray-50 border border-gray-600 p-1 rounded-lg m-1 w-20" type="text" onChange={(e)=>setInfoNuevaVenta({...infoNuevaVenta,precio:e.target.value})} value={infoNuevaVenta.precio}></input></td>
        </>
      ) : (
        <>
      ...
      <td>
        {edit?(<FontAwesomeIcon icon={faCheckSquare} className="text-green-600" onClick={() => actualizarventa()}/>):(
        <button onClick={() => setEdit(!edit)} className="ml-1 text-yellow-200 hover:text-yellow-900">
          <FontAwesomeIcon icon={faEdit} />
        </button>)
        }
        <button className="ml-1 text-red-500 hover:text-red-900">
